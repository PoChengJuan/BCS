...
Module Module_CreateMonthReport
  Public Function O_Process_Message(ByVal PlatForm As String,
    ...
    Try
      ...
      Dim dicPlatForm_LotNo_Count As New Dictionary(Of String, clsPLANFORM_LOTNO_LIST)
      ...
      Dim File_Path = ""
      '檢查資料
      If Check_Data(PlatForm, Start_time, End_Time, dicPlatForm_LotNo_Count, ret_strResultMsg) = False Then
        Return False
      End If
      ''取得更新資料
  ...
  Private Function Check_Data(ByRef ret_PlatForm As String,
                              ...
                              ByRef ret_dicPlatForm_LotNo_Count As Dictionary(Of String, clsPLANFORM_LOTNO_LIST),
                              ByRef ret_strResultMsg As String) As Boolean
    Try
