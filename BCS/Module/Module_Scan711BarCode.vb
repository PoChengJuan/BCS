...
Module Module_Scan711BarCode
  Public Function O_Process_Message(ByVal PlatForm As String,
                                    ...
                                    ByVal BarCode3 As String,
                                    ByVal BarCode4 As String,
    ...
    Try
      ...
      '檢查資料
      If Check_Data(PlatForm, LotNo, BarCode1, BarCode2, BarCode3, BarCode4, ret_strResultMsg) = False Then
        Return False
      End If
      ''取得更新資料
      If Get_Data(PlatForm, LotNo, BarCode1, BarCode2, BarCode3, BarCode4, ret_strResultMsg, dicAddStore_Head, dicAddStore_Item) = False Then
        Return False
      End If
      ''取得要更新到DB的SQL
  ...
  ''檢查資料
  Private Function Check_Data(ByVal ret_PlatForm As String,
                              ByVal ret_LotNo As String,
                              ByVal ret_BarCode1 As String,
                              ByVal ret_BarCode2 As String,
                              ByVal ret_BarCode3 As String,
                              ByVal ret_BarCode4 As String,
                              ByRef ret_strResultMsg As String) As Boolean
    Try
      Dim dicStore_Item = STORE_ITEMManagement.GetDataDictionaryByALL_BarCode(ret_BarCode1, ret_BarCode2, ret_BarCode3, ret_BarCode4)
      If dicStore_Item.Any Then
        ret_strResultMsg = "條碼重覆"
        Return False
      End If
      Return True
    Catch ex As Exception
  ...
  Private Function Get_Data(ByVal ret_PlatForm As String,
                            ...
                            ByRef ret_dicAddStore_Item As Dictionary(Of String, clsSTORE_ITEM)) As Boolean
    Try
