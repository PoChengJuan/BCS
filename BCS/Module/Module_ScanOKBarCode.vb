...
Module Module_ScanFamilyBarCode
  Public Function O_Process_Message(ByVal PlatForm As String,
    ...
    Try
      ...
      '檢查資料
      If Check_Data(PlatForm, LotNo, BarCode1, ret_strResultMsg) = False Then
        Return False
      End If
      ''取得更新資料
      If Get_Data(PlatForm, LotNo, BarCode1, "", "", "", ret_strResultMsg, dicAddStore_Head, dicAddStore_Item) = False Then
        Return False
      End If
      ''取得要更新到DB的SQL
  ...
  Private Function Check_Data(ByVal ret_PlatForm As String,
                              ...
                              ByRef ret_strResultMsg As String) As Boolean
    Try
      Dim dicStore_Item = STORE_ITEMManagement.GetDataDictionaryByALL_BarCode(ret_BarCode1, "", "", "")
